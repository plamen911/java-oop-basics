...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        System.out.printf("Total healed _06Animals: %d%n", AnimalClinic.healedAnimalsCount);
        System.out.printf("Total rehabilitated _06Animals: %d%n", AnimalClinic.rehabilitedAnimalsCount);

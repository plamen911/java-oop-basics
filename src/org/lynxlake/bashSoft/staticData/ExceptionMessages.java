...
public class ExceptionMessages {
    ...
    public static final String STUDENT_ALREADY_ENROLLED_IN_GIVEN_COURSE = "%s already enrolled in %s.";
    public static final String NOT_ENROLLED_IN_COURSE = "Student is not enrolled on this course.";
